...
public class Servlet_Cliente extends HttpServlet {
        ...
        if( (acao!=null) && (tipo!=null) ) {
            ...
            if(acao.equals("cad")){
                ...
                if(tipo.equals("socio")) {
                    if(Application.Apl_Cliente.incluirSocio(nome, endereco, telefone, sexo, cpf, data_nascimento) == Application.Apl_Cliente.RESULT_OK){}
                }
    ...
    public static List consultarTodosRegistros() {
        return Apl_Default.consultarTodosRegistros("Cliente");
    }
