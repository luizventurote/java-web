 ...
 */
public class Apl_Devolucao extends Apl_Default {

    /**
    * Class main name base
    */
    private static String classMainName = "Devolucao";

    
    /**
    * Constructor
    */
    public Apl_Devolucao() {
    ...
    */
    public static int incluir(Cliente cli, Titulo tit){
        ...
        Devolucao a =  new Devolucao(cli, tit);
     ...
     * Atualizar
     */
    public static int update(Devolucao obj) throws Exception, SQLException, HibernateException {
    ...
    public static int deletar(String tabela, int id) throws Exception, SQLException, HibernateException {
        ...
        // Get object
        Devolucao obj = (Devolucao) getRegistro(tabela, id);
    ...
    */
    public static String getFormToUpdate(int id) {
        ...
        // Main Object
        Devolucao main_obj = (Devolucao) Apl_Default.getRegistro(classMainName, id);
